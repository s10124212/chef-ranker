...
INSERT INTO "new_NewsItem" ("category", "dataExtracted", "fetchedAt", "id", "imageUrl", "publishedAt", "source", "summary", "title", "url") SELECT "category", "dataExtracted", "fetchedAt", "id", "imageUrl", "publishedAt", "source", "summary", "title", "url" FROM "NewsItem";
DROP TABLE "NewsItem";
